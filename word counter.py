# write a function which takes 1 string as an argument, finds out the number of words in that
# string, then returns that number.
#
...
# str_3 = "Anyway, like I was sayin', shrimp is the fruit of the sea. You can barbecue it, boil it, broil it,
# bake it,
# \saute it. Dey's uh, shrimp-kabobs, shrimp creole, shrimp gumbo. Pan fried, deep fried, stir-fried.
# There's pineapple \
# shrimp, lemon shrimp, coconut shrimp, pepper shrimp, shrimp soup, shrimp stew, shrimp salad,
# shrimp and potatoes, \
...
input_user = input("type a String")

print("The String: \"James Bond is 007.\" has", functionCounterWord(str_1)," words")
print("The String: \"When the moon hits your eye like a big pizza pie, that's amore!\" has", functionCounterWord(str_2)," words")
print("The String: \"Anyway, like I was sayin', shrimp is the fruit of the sea. You can barbecue it, boil it, broil it, bake it, \
saute it. Dey's uh, shrimp-kabobs, shrimp creole, shrimp gumbo. Pan fried, deep fried, stir-fried. There's pineapple \
shrimp, lemon shrimp, coconut shrimp, pepper shrimp, shrimp soup, shrimp stew, shrimp salad, shrimp and potatoes, \
shrimp burger, shrimp sandwich. That- that's about it.\" has ", functionCounterWord(str_3)," words")
print("The String: \"",input_user,"\" has ",functionCounterWord(input_user)," words")